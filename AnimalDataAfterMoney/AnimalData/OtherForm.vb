Public Class OtherAnimalForm
    ...
    Private Sub AddBtn_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        Try
            ...
            OtherInfoTableAdapter.Insert(TxtWeight.Text, RTxtWeight.Text, RTxtGeneral.Text, RTxtVaccinations.Text, OtherInfoTableAdapter.MaxIndex + 1, BasicInfoForm.AnimalMasterTableAdapter.GetCaseNumMax)
            Me.Close()
