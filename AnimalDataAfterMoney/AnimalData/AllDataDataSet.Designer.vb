...
Partial Public Class AllDataDataSet
    ...
    Partial Public Class OtherInfoDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOtherInfoRow(ByVal weight As String, ByVal appearance As String, ByVal vaccinations As String, ByVal generalDescription As String, ByVal caseNum As Integer) As OtherInfoRow
            Dim rowOtherInfoRow As OtherInfoRow = CType(Me.NewRow,OtherInfoRow)
            Dim columnValuesArray() As Object = New Object() {weight, appearance, vaccinations, generalDescription, Nothing, caseNum}
    ...
    Partial Public Class CostReportDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddCostReportRow(ByVal name As String, ByVal cost As Decimal) As CostReportRow
    ...
    Partial Public Class CostReportRow
        ...
        Public Property cost() As Decimal
            Get
                Return CType(Me(Me.tableCostReport.costColumn), Decimal)
            End Get
...
Namespace AllDataDataSetTableAdapters
    ...
    Partial Public Class OtherInfoTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [OtherInfo] WHERE (([weight] = @Original_weight) AND ([Index] = @Orig" & _
                "inal_Index) AND ([caseNum] = @Original_caseNum))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [OtherInfo] ([weight], [appearance], [vaccinations], [generalDescript" & _
                "ion], [Index], [caseNum]) VALUES (@weight, @appearance, @vaccinations, @generalD" & _
                "escription, @Index, @caseNum);" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT weight, appearance, vaccinations, general" & _
                "Description, [Index], caseNum FROM OtherInfo WHERE (caseNum = @caseNum)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [OtherInfo] SET [weight] = @weight, [appearance] = @appearance, [vaccinati" & _
                ...
                "ex, [caseNum] = @caseNum WHERE (([weight] = @Original_weight) AND ([Index] = @Or" & _
                "iginal_Index) AND ([caseNum] = @Original_caseNum));" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT weight, appearance, " & _
                "vaccinations, generalDescription, [Index], caseNum FROM OtherInfo WHERE (caseNum" & _
                " = @caseNum)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT weight, appearance, vaccinations, generalDescription, [Index], caseNum FRO" & _
                "M OtherInfo"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)> _
        Public Overridable Overloads Function Delete(ByVal Original_weight As Integer, ByVal Original_Index As Integer, ByVal Original_caseNum As Integer) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_weight, Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)> _
        Public Overridable Overloads Function Insert(ByVal weight As Integer, ByVal appearance As String, ByVal vaccinations As String, ByVal generalDescription As String, ByVal Index As Integer, ByVal caseNum As Integer) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(weight, Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Overloads Function Update(ByVal weight As Integer, ByVal appearance As String, ByVal vaccinations As String, ByVal generalDescription As String, ByVal Index As Integer, ByVal caseNum As Integer, ByVal Original_weight As Integer, ByVal Original_Index As Integer, ByVal Original_caseNum As Integer) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(weight, Integer)
            If (appearance Is Nothing) Then
                Throw New Global.System.ArgumentNullException("appearance")
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_weight, Integer)
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_Index, Integer)
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_caseNum, Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open) _
                        <> Global.System.Data.ConnectionState.Open) Then
                Me.Adapter.UpdateCommand.Connection.Open()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Overloads Function Update(ByVal weight As Integer, ByVal appearance As String, ByVal vaccinations As String, ByVal generalDescription As String, ByVal caseNum As Integer, ByVal Original_weight As Integer, ByVal Original_Index As Integer, ByVal Original_caseNum As Integer) As Integer
            Return Me.Update(weight, appearance, vaccinations, generalDescription, Original_Index, caseNum, Original_weight, Original_Index, Original_caseNum)
        End Function
    ...
    Partial Public Class CostReportTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT name FROM CostReport"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "INSERT INTO CostReport" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                  (name, cost)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "VALUES (@name,@cost)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@cost", Global.System.Data.SqlDbType.Money, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "cost", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)> _
        Public Overridable Overloads Function Insert(ByVal name As String, ByVal cost As Decimal) As Integer
            If (name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("name")
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(name, String)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, False)> _
        Public Overridable Overloads Function InsertCost(ByVal name As String, ByVal cost As Decimal) As Integer
            Dim command As Global.System.Data.SqlClient.SqlCommand = Me.CommandCollection(1)
            If (name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("name")
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        Public Property animalMasterTableAdapter() As animalMasterTableAdapter
            ...
            End Get
            Set(value As animalMasterTableAdapter)
        ...
        Public Property CatInfoTableAdapter() As CatInfoTableAdapter
            ...
            End Get
            Set(value As CatInfoTableAdapter)
        ...
        Public Property ClientTableTableAdapter() As ClientTableTableAdapter
            ...
            End Get
            Set(value As ClientTableTableAdapter)
        ...
        Public Property dogInfoTableAdapter() As dogInfoTableAdapter
            ...
            End Get
            Set(value As dogInfoTableAdapter)
        ...
        Public Property OtherInfoTableAdapter() As OtherInfoTableAdapter
            ...
            End Get
            Set(value As OtherInfoTableAdapter)
        ...
        Public Property OtherClientReportTableAdapter() As OtherClientReportTableAdapter
            ...
            End Get
            Set(value As OtherClientReportTableAdapter)
        ...
        Public Property CostReportTableAdapter() As CostReportTableAdapter
            ...
            End Get
            Set(value As CostReportTableAdapter)
