Public Class formEdit
    ...
    Private Sub AnimalMasterDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles AnimalMasterDataGridView.CellContentClick
        ...
        If e.ColumnIndex = 1 Then
            ...
            If AnimalMasterDataGridView.Rows(e.RowIndex).Cells(9).Value = True Then
                ...
                CostReportTableAdapter.InsertCost("Micro-chipped", "No Expense")
            Else

                ClientTableTableAdapter.UpdateClientReport("No", "Micro-chipped")
                CostReportTableAdapter.InsertCost("Micro-chipped", "$75.00")
            ...
            ElseIf CatInfoDataGridView.Visible = True Then
                ...
                If chkRabiesCat.Checked = True Then
                    ClientTableTableAdapter.Insert("Yes", "Rabies Vaccination")
                Else
                    ClientTableTableAdapter.Insert("No", "Rabies Vaccination")
                End If
                StrReport = "CatDogReport"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim typeVar As Int32 = 0

        If typeSearch.Text.Contains("dog") Or typeSearch.Text.Contains("Dog") = True Then
            typeVar = 0
        ElseIf typeSearch.Text.Contains("cat") Or typeSearch.Text.Contains("Cat") = True Then
            typeVar = 1
        ElseIf typeSearch.Text.Contains("other") Or typeSearch.Text.Contains("Other") = True Then
            typeVar = 2
        Else
            typeVar = -1
        End If
        ...
        If nameSearch.Text <> "" Then
            Try
                Me.AnimalMasterTableAdapter.FillByName(Me.AllDataDataSet.animalMaster, nameSearch.Text)
            Catch ex As System.Exception
                Me.AnimalMasterTableAdapter.Fill(Me.AllDataDataSet.animalMaster)
            End Try
        End If
        If typeVar <> -1 Then
            Try
                Me.AnimalMasterTableAdapter.FillByType(Me.AllDataDataSet.animalMaster, typeVar)
            Catch ex As System.Exception
                Me.AnimalMasterTableAdapter.Fill(Me.AllDataDataSet.animalMaster)
            End Try
        End If
        If ageSearch.Text <> "" Then
            Try
                Me.AnimalMasterTableAdapter.FillByAge(Me.AllDataDataSet.animalMaster, CType(ageSearch.Text, Integer))
            Catch ex As System.Exception
                Me.AnimalMasterTableAdapter.Fill(Me.AllDataDataSet.animalMaster)
            End Try

        End If
        If dobSearch.Value <> Dob Then
            Try
                Me.AnimalMasterTableAdapter.FillByDob(Me.AllDataDataSet.animalMaster, dobSearch.Text)
            Catch ex As System.Exception
                Me.AnimalMasterTableAdapter.Fill(Me.AllDataDataSet.animalMaster)
            End Try
        End If
        If doaSearch.Value <> Doa Then
            Try
                Me.AnimalMasterTableAdapter.FillByDoa(Me.AllDataDataSet.animalMaster, doaSearch.Text)
            Catch ex As System.Exception
                Me.AnimalMasterTableAdapter.Fill(Me.AllDataDataSet.animalMaster)
            End Try
        End If
        If ownerSearch.Text <> "" Then
            Try
                Me.AnimalMasterTableAdapter.FillByOwner(Me.AllDataDataSet.animalMaster, ownerSearch.Text)
            Catch ex As System.Exception
                Me.AnimalMasterTableAdapter.Fill(Me.AllDataDataSet.animalMaster)
            End Try
        End If
